                    ...
                    <?php if ($d_detail_penjualan['penjualan_id'] == $d['penjualan_id']) { ?>
                        <tr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="produk_id" class="form-control" onchange="this.form.submit()">
                                            ...
                                            while($d_produk =  mysqli_fetch_array($produk)){
                                                ?>
                                                <option value="<?= $d_produk['produk_id']; ?>" <?php if($d_produk['produk_id']==$d_detail_penjualan
                                                ['produk_id']) { echo "selected"; }?>><?= $d_produk['nama_produk']; ?></option>
                                            <?php } ?>                                     
                                        </select>
                                    </div>
                                </form>
                            ...
                            <td>
                                ...
                                <td>
                                <form method="post" action="proses_detail_pembelian.php">
                                    <input type="text" name="detail_id" value="<?= $d_detail_penjualan['detail_id']; ?>" hidden>
                                    <input type="text" name="pelanggan_id" value="<?= $d['pelanggan_id']; ?> "hidden>
